...
class CrearProveedorView(CreateView):
    ...
    success_url= reverse_lazy('login:proveedorapp')

class CrearProductoView(CreateView):
    template_name="products.html"
    form_class=ProductoForm
    success_url= reverse_lazy('login:productosapp')

class CrearClienteView(CreateView):
    template_name="client.html"
    form_class=ClienteForm
    success_url= reverse_lazy('login:clientesapp')

class CrearCotizacionView(CreateView):
    template_name="cotizacion.html"
    form_class=CotizacionForm
    success_url= reverse_lazy('login:cotizacionapp')

class CrearEmpleadoView(CreateView):
    template_name="admin.html"
    form_class=EmpleadoForm
    success_url= reverse_lazy('login:usuariosapp')

class CrearVentaView(CreateView):
    template_name="ventas.html"
    form_class=VentaForm
    success_url= reverse_lazy('login:ventasapp')